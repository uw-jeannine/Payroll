...
<li  <?=(isset($_GET['action']) && $_GET['action']=='Contact')?'class="active" data-title="us"':''; ?>><a style="color:white;" href="./admin.php?action=contact">Contact us</a>&nbsp;&nbsp;|</li>
...
&copy;&nbsp;&nbsp;Uwiringiyimana jeannine&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('Y', time()); ?>
</div>
<!--end of includes-->
</div>
